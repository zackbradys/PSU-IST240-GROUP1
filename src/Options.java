...
public class Options extends JPanel implements ActionListener {
    ...
    String CharacterChoice, ThemeChoice;
    
    boolean characterChosen = false;
    boolean themeChosen = false;
    ...
    public void actionPerformed(ActionEvent x) {
        ...
        if (obj == Lion) {
            ...
            CharacterChoice = "LionChoice";
            characterChosen = true;
        } else if (obj == Saquon) {
            character = "Saquon";
            cText.setText(character);
            CharacterChoice = "SaquonChoice";
            characterChosen = true;
        } else if (obj == Frannie) {
            character = "Frannie";
            cText.setText(character);
            CharacterChoice = "FrannieChoice";
            characterChosen = true;
        }
        ...
        if (obj == sports) {
            ...
            theme = "Math";
            tText.setText(theme);
            ThemeChoice = "MathChoice";
            themeChosen = true;
        } else if (obj == java) {
            theme = "Java";
            tText.setText(theme);
            ThemeChoice = "JavaChoice";
            themeChosen = true;
        }

        if ((characterChosen == true) && (themeChosen == true)) {
            x2.openWriterXML("groupOneXML.xml");
            x2.writeObject(CharacterChoice);
            x2.writeObject(ThemeChoice);
            x2.closeWriterXML();
        }
    }
}
