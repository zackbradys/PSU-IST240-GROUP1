...
public class Options extends JPanel implements ActionListener {
    ...
    public void actionPerformed(ActionEvent x) {
        ...
        if (obj == Lion) {
            ...
            String CharacterChoice = "LionChoice";
        ...
        if (obj == Saquon) {
            ...
            String CharacterChoice = "SaquonChoice";
            x2.openWriterXML("groupOneXML.xml");
            x2.writeObject(CharacterChoice);
            x2.closeWriterXML();
        }
        if (obj == Frannie) {
            ...
            String CharacterChoice = "FrannieChoice";
            x2.openWriterXML("groupOneXML.xml");
            x2.writeObject(CharacterChoice);
            x2.closeWriterXML();
        }
        if (obj == sports) {
            ...
            String ThemeChoice = "SportsChoice";
            x2.openWriterXML("groupOneXML.xml");
